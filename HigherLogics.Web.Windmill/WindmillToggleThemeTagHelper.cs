...
namespace HigherLogics.Web.Windmill
{
    ...
    public class WindmillToggleThemeTagHelper : WindmillTagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.AddDefault("x-on:click", "toggleTheme");
            output.Attributes.AddDefault("aria-label", "Toggle color mode");

            output.Content.AppendHtmlLine(@"<template x-if=""!dark"">
